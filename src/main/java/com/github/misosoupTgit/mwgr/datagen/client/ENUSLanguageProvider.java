...
public class ENUSLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        addBlock(MWGRBlocks.HEAVY_WATER_GENERATOR, "Heavy Water Generator");
        addBlock(MWGRBlocks.LAVA_GENERATOR, "Lava Generator");

        add("advancements.mwgr.get_water_gen.title", "No Turbine Needed");
        add("advancements.mwgr.get_heavywater_gen.title", "The perfect companion for the most powerful generator!");
        ...
        add("advancements.mwgr.get_heavywater_gen.description", "Get a Heavy Water Generator");
        ...
        add("description.mwgr.heavywater_generator", "Provides an infinite supply of heavy water.");
